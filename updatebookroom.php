...
//room finding
$sql = "INSERT INTO `test`.`booking` (`uid`, `hotelid`, `roomid`, `days`) VALUES (".$_SESSION["userid"].",".$_SESSION["hotelid"].",".$_SESSION["roomid"].",".substr($_SESSION["days"] ,0,2).substr($_SESSION["days"] ,3,2).")";
...
echo '<h1><font color="red">DONE!!</font></h1>';
